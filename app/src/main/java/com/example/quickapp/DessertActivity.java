...
public class DessertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAddCookies = findViewById(R.id.btnAddCookies);
        Button btnAddIcecreamCone = findViewById(R.id.btnAddIcecreamCone);
        Button btnAddSundea = findViewById(R.id.btnAddSundea);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent cartIntent = new Intent(DessertActivity.this, cartActivity.class);
                cartIntent.putStringArrayListExtra("shoppingCart", (ArrayList<String>) shoppingCart);
                startActivity(cartIntent);
            }
        });

        btnAddCookies.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addToCart("Box of cookies", 9.99);
            }
        });



        btnAddIcecreamCone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addToCart("Large ice cream cone", 2.99);
            }
        });

        btnAddSundea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addToCart("Large Sundea", 5.99);
            }
        });
    }
    @Override
