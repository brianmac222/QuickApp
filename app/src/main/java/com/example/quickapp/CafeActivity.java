...
public class CafeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAddCoffee = findViewById(R.id.btnAddcoffee);
        Button btnAddIcecreamCone = findViewById(R.id.btnAddLatte);
        Button btnAddSundea = findViewById(R.id.btnAddfrappuccino);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent cartIntent = new Intent(CafeActivity.this, cartActivity.class);
        ...
        btnAddSundea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addToCart("Large Frappuccino", 5.99);
            }
        });
    }
    @Override
